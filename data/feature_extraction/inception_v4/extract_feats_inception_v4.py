...
def parse_opt():
    ...
    parser.add_argument('--out_dir', type=str, default='/data1/ailab_view/wenhaojiang/data/feat_inception_v4',
                        help='base dir for output')
    parser.add_argument('--fc_dir', type=str, default='cocotalk_inception_v4_fc_flip',
                        help='dir for fc')
    parser.add_argument('--att_dir', type=str, default='cocotalk_inception_v4_att_flip',
                        help='dir for att')
    parser.add_argument('--model_path', type=str, default='/data1/ailab_view/image_captioning/self-critical.pytorch-master/feature_extraction/inception_v4/checkpoints',
                        help='path for inception_v4.ckpt')
...
def get_image_id(file_name):
    ...
    image_id = image_name # ai_challenge
    return image_id
