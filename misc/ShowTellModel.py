...
class ShowTellModel(nn.Module):
    ...
    def sample(self, fc_feats, att_feats, opt={}):
        ...
        return torch.cat([_.unsqueeze(1) for _ in seq], 1), torch.cat([_.unsqueeze(1) for _ in seqLogprobs], 1), torch.cat([_.unsqueeze(1) for _ in logprobs_all[1:]], 1).contiguous()